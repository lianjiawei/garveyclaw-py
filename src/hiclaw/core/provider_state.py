...
def get_provider() -> str:
    ...
    try:
        from hiclaw.core.model_profiles import get_active_model_profile
...
def set_provider(provider: str) -> str:
    ...
    try:
        from hiclaw.core.model_profiles import find_profile_by_protocol, set_active_model_profile
